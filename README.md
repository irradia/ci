...
The [irradia](https://www.github.com/irradia) CI scripts.

![ci](./readme.jpg?raw=true)

_Image by [marcinjozwiak](https://pixabay.com/users/marcinjozwiak-12652484/) from [Pixabay](https://pixabay.com/photos/production-facility-logistic-4408573/)_

### What Is This?

The contents of this repository define the CI scripts used to continuously
build the various [irradia](https://www.github.com/irradia) modules.
...
The above set of configuration files will cause binaries to be published to the `IRRADIA-Simplified/android-binaries`
...
`https://github.com/irradia/example-app`, showing the exact commit that
